...
export const SOURCE_DETAILS: Partial<Record<SourceKey, SourceDetail>> = {
  solar: {
    ...
    recentGrowth: '+7.7 GW/anno (2022→2023)',
    historical: [
      { year: 2004, value: 0.03 },
      { year: 2005, value: 0.06 },
      { year: 2006, value: 0.12 },
      { year: 2007, value: 0.30 },
      { year: 2008, value: 0.43 },
      { year: 2009, value: 1.14 },
      { year: 2010, value: 3.47 },
      { year: 2011, value: 12.75 },
      { year: 2012, value: 16.36 },
      { year: 2013, value: 17.61 },
      { year: 2014, value: 18.46 },
      { year: 2015, value: 18.92 },
      { year: 2016, value: 19.28 },
      { year: 2017, value: 19.68 },
      { year: 2018, value: 20.11 },
      { year: 2019, value: 20.86 },
      { year: 2020, value: 21.68 },
      { year: 2021, value: 22.63 },
      { year: 2022, value: 25.02 },
  ...
  wind_onshore: {
    ...
    recentGrowth: '+0.7 GW/anno (2022→2023)',
    historical: [
      { year: 2004, value: 1.26 },
      { year: 2005, value: 1.72 },
      { year: 2006, value: 2.13 },
      { year: 2007, value: 2.73 },
      { year: 2008, value: 3.73 },
      { year: 2009, value: 4.85 },
      { year: 2010, value: 5.80 },
      { year: 2011, value: 6.94 },
      { year: 2012, value: 8.14 },
      { year: 2013, value: 8.55 },
      { year: 2014, value: 8.70 },
      { year: 2015, value: 8.90 },
      { year: 2016, value: 9.39 },
      { year: 2017, value: 9.77 },
      { year: 2018, value: 10.03 },
      { year: 2019, value: 10.55 },
      { year: 2020, value: 10.88 },
      { year: 2021, value: 10.97 },
      { year: 2022, value: 11.38 },
  ...
  hydro: {
    ...
    italy2023: {
      value: 22.7,
      productionTWh: 37,
      context: '8.2 GW ad acqua fluente + 14.5 GW a serbatoio. Capacità sostanzialmente stabile dagli anni \'80.',
    },
    targets: [
      { year: 2030, value: 22.7, label: 'PNIEC 2030 (stabile)' },
    ],
    recentGrowth: 'Stabile (saturazione bacini italiani)',
    historical: [
      { year: 2004, value: 22.0 },
      { year: 2005, value: 22.1 },
      { year: 2006, value: 22.2 },
      { year: 2007, value: 22.3 },
      { year: 2008, value: 22.3 },
      { year: 2009, value: 22.4 },
      { year: 2010, value: 22.5 },
      { year: 2011, value: 22.5 },
      { year: 2012, value: 22.6 },
      { year: 2013, value: 22.6 },
      { year: 2014, value: 22.7 },
      { year: 2015, value: 22.7 },
      { year: 2016, value: 22.7 },
      { year: 2017, value: 22.7 },
      { year: 2018, value: 22.7 },
      { year: 2019, value: 22.7 },
      { year: 2020, value: 22.7 },
      { year: 2021, value: 22.7 },
      { year: 2022, value: 22.7 },
      { year: 2023, value: 22.7 },
    ],
    historicalLabel: 'Capacità installata (GW)',
  },
  ...
  geothermal: {
    ...
    recentGrowth: '+0.01 GW/anno (crescita lenta)',
    historical: [
      { year: 2004, value: 0.71 },
      { year: 2005, value: 0.71 },
      { year: 2006, value: 0.72 },
      { year: 2007, value: 0.73 },
      { year: 2008, value: 0.74 },
      { year: 2009, value: 0.74 },
      { year: 2010, value: 0.75 },
      { year: 2011, value: 0.77 },
      { year: 2012, value: 0.77 },
      { year: 2013, value: 0.78 },
      { year: 2014, value: 0.80 },
      { year: 2015, value: 0.81 },
      { year: 2016, value: 0.82 },
      { year: 2017, value: 0.82 },
      { year: 2018, value: 0.83 },
      { year: 2019, value: 0.84 },
      { year: 2020, value: 0.86 },
  ...
  biomass: {
    ...
    recentGrowth: 'Stabile o in leggero calo',
    historical: [
      { year: 2004, value: 1.0 },
      { year: 2005, value: 1.2 },
      { year: 2006, value: 1.5 },
