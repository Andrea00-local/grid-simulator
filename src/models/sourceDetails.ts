...
export const SOURCE_DETAILS: Partial<Record<SourceKey, SourceDetail>> = {
  ...
  gas_ccgt: {
    ...
    italy2023: {
      value: 132,
      context: 'Somma gas naturale + altri fossili. Prima fonte di produzione elettrica in Italia al 2023, in calo progressivo grazie alla crescita delle rinnovabili.',
    },
    targets: [
      { year: 2030, value: 60, label: 'PNIEC 2030' },
      { year: 2050, value: 12, label: 'Net Zero 2050' },
    ],
    recentGrowth: '−25 TWh/anno (2022→2023, in calo)',
    historical: [
      { year: 2000, value: 193 },
      { year: 2001, value: 186 },
      { year: 2002, value: 194 },
    ...
    historicalLabel: 'Produzione annua (TWh) — Gas + altri fossili, fonte: Ember',
  },
  ...
  coal: {
    ...
    recentGrowth: '−10 TWh/anno (2022→2023, phase-out)',
    historical: [
      { year: 2000, value: 26 },
      { year: 2001, value: 32 },
      { year: 2002, value: 35 },
    ...
    historicalLabel: 'Produzione annua (TWh) — fonte: Ember',
  },
